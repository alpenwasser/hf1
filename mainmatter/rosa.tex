...
\begin{align}
    \frac{1}{n}
    \bigg[
        \log{d_1} + \log{d_2} + \log{d+3} + \quad\ldots\quad + \log{d_n}
    \bigg]
    &=
    \frac{1}{n}
    \log{\bigg(
        d_1 \cdot d_2 \cdot d_3 \cdot \quad\ldots\quad \cdot d_n 
    \bigg)}
    \nonumber\\
    &=
    \log{\sqrt[\leftroot{2}n]{d_1 d_2 d_3 \quad\ldots\quad d_n}}
    \nonumber\\
    &=
    \log{R}
    \label{eq:gmd:2}
...
\begin{align}
    \log{R}
    &=
    \frac{n \log{r_1} + n \log\big(r_{12} \cdot r_{13} \cdot \quad\ldots\quad \cdot r_{1n}\big)}{n^2}
    \nonumber\\
    &=
    \frac{1}{n}
    \bigg(\log{r_1} + \log\big(r_{12} \cdot r_{13} \cdot \quad\ldots\quad \cdot r_{1n}\big)\bigg)
    \label{eq:multCond:3}
\end{align}
...
man den Kreisumfang in $n$ gleiche Segmente mit Endpunkten $A, B, C, D, E, \quad\ldots\quad
...
\begin{equation}
    \label{eq:multCond:5}
    x^n - a^n = \overline{MA} \cdot \overline{MB} \cdot \quad\ldots\quad \cdot \overline{MN}
\end{equation}
...
\begin{equation}
    \label{eq:multCond:6}
    x^{n-1} + ax^{n-2} + a^{2}x^{n-3} \quad\ldots\quad a^{n-1} = \overline{MB} \cdot \overline{MC} \cdot \quad\ldots\quad \cdot \overline{MN}
\end{equation}
...
\begin{align}
    na^{n-1} 
    &= 
    \overline{AB} \cdot \overline{AC} \cdot \quad\ldots\quad \cdot \overline{AN}
    \nonumber\\
    &=
    a_{12} \cdot a_{13} \cdot \quad\ldots\quad \cdot a_{1n}
    \label{eq:multCond:6}
\end{align}
...
\begin{align}
    L_A
    &=
    L_1 + 2M_2 + 2M_4 + 2M_6 + \quad\ldots\quad + 2M_{n-1} - 2M_1 - 2M_3 - 2M_5 \quad \ldots \quad - M_n
    \nonumber\\
    &=
    (L_1 - M_1)  - (M_1 - M_2) - (M_3 - M_4) - (M_5 - M_6) \quad\ldots\quad
    \nonumber\\
    &\qquad+
    (M_2 - M_3) + (M_4 - M_5) + (M_6 - M_7) + \quad\ldots
    \nonumber\\
    &=
    2l
    \left[
    ...
    \right]
    - 2l \log\frac{2}{1} - 2l \log\frac{4}{3} - 2l \log\frac{6}{5} - \quad\ldots
    \nonumber\\
    &\qquad+
    2l \log\frac{3}{2} + 2l \log\frac{5}{4} + 2l \log\frac{7}{6} + \quad\ldots
    \nonumber\\
    &=
    2l\left[
        \log\frac{d}{\rho} + \frac{1}{4}
    \right]
    -
    2l \log\bigg(\frac{2 \cdot 4 \cdot 6 \cdot 8 \cdot \quad\ldots}{1 \cdot 3 \cdot 5 \cdot 7 \cdot \quad\ldots}\bigg)
    +
    2l \log\bigg(\frac{3 \cdot 5 \cdot 7 \cdot 9 \cdot \quad\ldots}{2 \cdot 4 \cdot 6 \cdot 8 \cdot \quad\ldots}\bigg)
    \nonumber\\
    &=
    2l\left[
        \log\frac{d}{\rho} + \frac{1}{4}
    ...
    -
    2l \log\bigg(
        \frac{2^2 \cdot 4^2 \cdot 6^2 \cdot 8^2 \cdot \quad\ldots}
             {1^2 \cdot 3^2 \cdot 5^2 \cdot 7^2 \cdot 9^2 \cdot \quad\ldots}
    \bigg)
    \nonumber\\
    &=
    2l\left[
        ...
        -
        2 \log\bigg(
            \frac{2 \cdot 4 \cdot 6 \cdot 8 \cdot \quad \ldots \cdot (n-1)}
                 {1 \cdot 3 \cdot 5 \cdot 7 \cdot \quad \ldots \cdot (n-2)\sqrt{n}}
        \bigg)
    \right]
    \label{eq:nIW:1}
\end{align}
...
\begin{equation*}
    \frac{1 \cdot 3}{2^2} \cdot \frac{3 \cdot 5}{4^2} \cdot \frac{5 \cdot 7}{6^2} \quad\ldots\quad
    \frac{(2n-1)(2n+1)}{(2n)^2}
    =
    \frac{\pi}{2}
\end{equation*}
...
\begin{alignat*}{4}
    ...
    2n &= 38     ,&\  A &= \  \ldots\          \  &= 0.4253 \\
    2n &= 70     ,&\  A &= \  \ldots\          \  &= 0.4373 \\
    2n &= \infty ,&\  A &= \  \ldots\          \  &= 0.4516
\end{alignat*}
...
\begin{align*}
    L
    &=
    L_1 - M_1 + M_2 - M_3 + M_4 - \quad \ldots
    \nonumber\\
    &=
    2l\left[\log\frac{d}{\rho} + \frac{1}{4}\right]
    +
    (M_2 - M_3) + (M_4 - M_5) + \quad \ldots
    \\
    &=
    2l
    \left[
        ...
        +
        \log\bigg(
            \frac{3 \cdot 5 \cdot 7 \cdot \quad\ldots}
                 {2 \cdot 4 \cdot 6 \cdot \quad\ldots}
        \bigg)
    \right]
    \\
    &=
...
\begin{align}
    L_A
    &=
    L_1 - 2M_1 + 2M_2 - 2M_3 + 2M_4 + \quad \ldots 
    \nonumber\\
    &=
    L_1 - M_1 - (M_1 - M_2) + (M_2 - M_3) - (M_3 - M_4) \quad \ldots
    \nonumber\\
    &=
    4 \pi a
    \left[
    ...
    \left[
        ...
        -
        2\log\left(
            \frac{2 \cdot 4 \cdot 6 \cdot 8 \quad \ldots \quad (n-1)}
                 {1 \cdot 3 \cdot 5 \cdot 7 \quad \ldots \quad (n-2)\sqrt{2}}
        \right)
    \right]
    \quad \text{f\"ur $2n = 8$ Windungen}
    \nonumber\\
