\begin{titlingpage}
    ...
    \vspace*{7em}
    \newcommand{\mytitle}{{\textbf{\fontsize{12mm}{1em}\selectfont Induktivit\"aten}}}
    ...
    \textcolor{\titlecolor}{%
        ...
        \vspace*{6mm}
        \begin{DoubleSpace}
            \fontsize{6mm}{1em}\selectfont 
            Ein Vergleich von analytischen N\"aherungsformeln und Simulationen
            f\"ur Selbst- und Gegeninduktivit\"aten linearer Leiter\\
        \end{DoubleSpace}
    }
